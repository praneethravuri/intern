...
// Every other harness keeps using tether wait; nothing outside this package
// or the CLI's "hooks" command tree knows Claude Code hooks exist.
package claudecode

import "strings"

// EnvelopeMarker prefixes every tether-injected block of mail so the
...
const EnvelopeMarker = "\u2063TETHER_OP: v1 "
...
// ParseEnvelope reports whether s is a tether envelope, and if so its kind
// and body.
