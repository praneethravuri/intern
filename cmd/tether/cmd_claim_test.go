...
func TestClaimHappyPath(t *testing.T) {
	...
	requireContains(t, r.stdout, "Next: tether release src/main.go --if-claim-id abc123", "stdout")
}
...
func TestClaimConflictExitsFive(t *testing.T) {
	...
	requireContains(t, r.err.Error(), "tether claims", "error")
}
...
func TestClaimsEmpty(t *testing.T) {
	...
	requireContains(t, r.stdout, "Next: tether claim <key>", "stdout")
}
